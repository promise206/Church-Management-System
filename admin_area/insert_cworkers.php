...
?>
      <div class="editBox">
              ...
              <h1 style="text-align: center; color: #46594c;font-size: 20px; font-weight: bolder;">Insert Current Workers </h1>
                <form action="" method="post" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    <div class="col-md-6 padding-top-10">
                      ...
                      <input type="text" class="form-control" id="ordained" name="email" placeholder="" required>
                    </div>
                  ...
                  <div class="row">
                  <div class="col-md-6">
                    <label for="w_bio" class="control-label">Biography:</label>
                    <textarea class="form-control" id="w_bio" name="w_bio" placeholder="Biography"></textarea>
                  </div>
                  </div>
                  <div class="row">
                      <div class="col-md-2">
      ...
      if (isset($w_image)) {
        if(!empty($w_image)){
          if (($extension=='jpg' || $extension=='jpeg' || $extension=='png') && ($w_image_type=='image/png' || $w_image_type=='image/jpeg' || $w_image_type=='image/jpg') && $w_image_size<$max_image_size ) {
            ...
            if(move_uploaded_file($w_image_tmp,"../workers/images/$w_image")){

              $insert_w = "insert into current_workers(worker_cat,worker_email, worker_firstname, worker_lastname, worker_image, worker_phoneno, worker_bio) VALUES ('$w_cat','$w_email', '$w_firstname', '$w_lastname', '$w_image', '$w_mobile','$w_bio')";
