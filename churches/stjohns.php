        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          ...
          <li class="dropdown">
            ...
            <div id="myDropdown" class="dropdown-content">
              <a href="stjohns.php">St John's Anglican Church Nnobi</a>
              <a href="allsaints.php">All Saints Anglican Church Nnobi</a>
            </div>
          </li>
...
<ul class="breadcrumb">
            ...
            <li class="active">St Johns Anglican Church Nnobi</li>
        </ul>
