                ...
                <form action="" method="post" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    <div class="col-md-6 padding-top-10">
                      ...
                      <input type="file" class="form-control" id="m_image" name="m_image" placeholder="" required><img src="members_images/<?php echo $member_image; ?> " width= "60" height="60">
                    </div>
        ...
        if(!empty($m_image)){
          if (($extension=='jpg' || $extension=='jpeg' || $extension=='png') && ($m_image_type=='image/png' || $m_image_type=='image/jpeg' || $m_image_type=='image/jpg') && $m_image_size<$max_image_size ) {
            ...
            if(move_uploaded_file($m_image_tmp,"members_images/$m_image")){
              ...
              $update_c = "update members set first_name='$m_firstname',last_name='$m_lastname', email='$m_email', address='$m_address', phone_no='$m_mobile', gender='$m_gender', date='$m_date', image='$m_image', country='$m_country', state='$m_state' where member_id='$m_id'";
