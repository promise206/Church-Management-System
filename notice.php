...
<nav class="navbar navbar-default" role="navigation">
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          ...
          <li class="active"><a href="members/member_register.php">Sign Up<span class="sr-only">(current)</span></a></li>
          <li class="active"><a href="#">About Us<span class="sr-only">(current)</span></a></li>

          <li class="dropdown">
            <a  class="dropbtn">Churches<span class="caret"></span></a>
            <div id="myDropdown" class="dropdown-content">
              <a href="#">St John's Anglican Church Nnobi</a>
        ...
        <div class="panel panel-default">
            ...
            <?php 
              ...
              $notices_id = $_GET['notices_id'];

              $get_notices = "select * from notices where notices_id = '$notices_id'";
              $run_notices = mysqli_query($con, $get_notices);
              $row_notices = mysqli_fetch_array($run_notices);
              $notices_title = $row_notices['notices_title'];
              $notices_body = $row_notices['notices_body'];

              echo "
              <div class='notice'>
              <div class='notice_title'>$notices_title</div><br><br> 
              <h1>$notices_body</h1>
              </div>";
