        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          ...
          <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
               <li><a href="#">All Saint's Ifite</a></li> 
               <li><a href="#">St Johns Umuafor</a></li> 
              </ul>
          </li>
          <li class="dropdown">
           ...
           <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
               <li><a href="#">St Paul's Model</a></li> 
               <li><a href="#">Zion Sec School</a></li> 
              </ul>
          </li>
          </ul>
...
<ul class="breadcrumb">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
             ...
             <h1 style="text-align: left; padding: 50px; padding: 50;"><?php youth();  ?></h1>
